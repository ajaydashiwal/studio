...
export default function CollectionReport() {
    ...
    const handleRowClick = (flatNo: string) => {
                ...
                <CardHeader>
                    <div className="flex flex-col sm:flex-row justify-between sm:items-center">
                        <div>
                            ...
                            <CardDescription>Total maintenance collection for the selected month. Click a row to see details.</CardDescription>
                        </div>
                        ...
                        <Table>
                            ...
                            <TableBody>
                                {loading ? (
                                    ...
                                    data.map(record => (
                                        <TableRow key={record.id} className="cursor-pointer" onClick={() => handleRowClick(record.flatNo)}>
            ...
            <Dialog open={!!selectedFlat} onOpenChange={(isOpen) => !isOpen && setSelectedFlat(null)}>
                <DialogContent className="w-full max-w-4xl h-auto sm:h-[90vh]">
                    <DialogHeader>
                        ...
                        <DialogDescription>
                            Showing full payment history.
                        </DialogDescription>
                    </DialogHeader>
                    <div className="mt-4">
                        {selectedFlat && <DataTable flatNo={selectedFlat} />}
                    </div>
                </DialogContent>
            </Dialog>
        </>
